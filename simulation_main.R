...
# observer <- create_observer(observer.name = "Willson", 
#                             skill = 6)
# 
# site_names <- list("Green Bay", "Vail", "Dublin", "Denver", "Phoenix",
#                    "New Orleans")
# elev <- list(320, 8160, 9, 5280, 3700, 0)
# temps <- 4:9
# 
# site_list <- mapply(create_site, 
#                     site.name = site_names, 
#                     elevation_ft = elev, 
#                     meanAnnualTemp_C = temps, 
#                     landClass = rep("urban/suburban", 3),
#                     SIMPLIFY = F)
# sites <- bind_rows(site_list)
# 
# species_flex <- list(create_species(species.name = "pika", 
#                                     prob.occurrence = 0.1, 
#                                     prob.detection = 0.4,
#                                     resp.elevation = 0.0005,
#                                     resp.temp = -0.001), 
#                      create_species(species.name = "seal", 
#                                     prob.occurrence = 0.8,
#                                     prob.detection = 0.8,
#                                     resp.elevation = -0.05), 
#                      create_species(species.name = "dog", 
#                                     prob.occurrence = 0.7,
#                                     prob.detection = 0.8)
# )
# species_flex <- bind_rows(species_flex)
# 
